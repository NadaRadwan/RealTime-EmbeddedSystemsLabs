...
* Lab Number:    5
* File name:     SEG4145_Lab_5
* Date:          March 22, 2017
*
*
*  Description
* *************
* The purpose of this lab was to design a UI to control the movement of the 
* arduino robot. This UI will be used to drive the robot around a maze and is 
    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        if (c == '\n') {
          ...
          switch(function) {
            case '1':
              client.println("Moving forwards!");
              moveForward(amount.toInt());
              break;
            case '2':
              client.println("Moving backwards!");
              moveBackward(amount.toInt());
              break;
            case '3':
              client.println("Rotating Clockwise!");
              rotateClockwise(amount.toInt());
              break;
            case '4':
              client.println("Rotating Counterclockwise!");
              rotateCounterClockwise(amount.toInt());
              break;
            case '5':
              readSonarSensor(client);
              break;
            case '6':
...
* Name       Type          Description
* ------     ------        ------------------
* client     WifiClient    The client to send the distance to
* 
******************************************************************************/
void readSonarSensor(WifiClient client) {
